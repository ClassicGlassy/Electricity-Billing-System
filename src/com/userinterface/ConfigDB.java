...
//        Row 4: Save and Reset Button
        ...
        gbc.gridx=3;
        DBreset = new buttonComponent("Reset",Color.BLACK,Color.white);
    ...
    private void reset(){
        ...
        JOptionPane.showMessageDialog(null,"Configuration reset to default.","Success",JOptionPane.INFORMATION_MESSAGE);
        login();
    }
